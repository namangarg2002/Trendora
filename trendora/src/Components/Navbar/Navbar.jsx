...
function Navbar({handleOrderPopup = () => {} }) {
  return (
    <div className='shadow-md bg-white text-black dark:text-black duration-200 relative z-40'>
        ...
        <div className='container flex justify-between items-center'>
          ...
          <div className='flex justify-between items-center gap-4'>
            <div className='relative group hidden sm:block'>
              ...
              className='w-[200px] sm:w-[200px] group-hover:w-[300px] transition-all duration-300 rounded-lg border border-gray-300
              py-1 px-2 text-sm focus:outline-none focus:border-1 focus:border-primary dark:border-gray-500 dark:bg-slate-800'/>
              <IoMdSearch
              className='text-slate-800 group-hover:text-primary absolute top-1/2 -translate-y-1/2 right-3'/>
            </div>
